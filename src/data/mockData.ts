...
export const mockPools: Pool[] = [
  ...
  { id: 'pool_home', name: 'Home & Rates', type: 'fixed', monthly_budget: 6500, reserve_as_essential: true, sort_order: 4, member_id: null },
  { id: 'pool_insurance', name: 'Insurance', type: 'fixed', monthly_budget: 4200, reserve_as_essential: true, sort_order: 5, member_id: null },
  ...
  { id: 'pool_kids', name: 'Kids & School', type: 'variable', monthly_budget: 2500, reserve_as_essential: true, sort_order: 8, member_id: null },
...
export const mockCommitments: Commitment[] = [
  ...
  { id: 'com_netflix', item: 'Netflix', pool_id: 'pool_subs', account_id: 'acc_credit', search_term: 'NETFLIX', amount: 199, day_of_month: 5, paid: false },
  { id: 'com_spotify', item: 'Spotify', pool_id: 'pool_subs', account_id: 'acc_credit', search_term: 'SPOTIFY', amount: 119, day_of_month: 7, paid: false },
